...
-- printed on the page):
--
-- * Section 18.4, "Shared String Table" (p. 1904)
--   in particular subsection 18.4.9, "sst (Shared String Table)" (p. 1912)
--
...
-- p. 1908) or @rPh@ (Phonetic Run, 18.4.6, p. 1910).
--
-- Section 18.4.8, "si (String Item)" (p. 1912)
data StringItem =
    StringItemText Text
